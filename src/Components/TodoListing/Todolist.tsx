...
const TodoList: React.FC<TodoListProps> = ({ todos, onToggleTodo, onEditTodo, onDeleteTodo }) => {
  ...
  return (
    <div className="p-5 h-120 overflow-y-auto">
      <ul className="space-y-2">
        {Array.isArray(todos) &&
          todos.map((todo) => (
            <li key={todo.id} className="flex items-center justify-between p-4 border rounded-lg shadow">
              ...
              <div>
                ...
                <button
                  ...
                  <svg width="20" height="20" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className="mr-1">
                    <path
                ...
                <button
                  ...
                  <svg width="20" height="20" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" className="mr-1">
                    <path
